...
_jquery.default.fn.extend({
  animateCSS: function animateCSS(animationName, callback) {
    ...
    this.addClass('animated ' + animationName).one(animationEnd, function () {
      (0, _jquery.default)(this).removeClass('animated ' + animationName);
...
(0, _jquery.default)(function () {
  (0, _jquery.default)('.hamburger').click(function () {
    (0, _jquery.default)(this).toggleClass('is-active');
  });

  function toggleCurtain() {
    var curtain = (0, _jquery.default)('.curtain');
    ...
    if (curtain.hasClass('curtain--hidden')) {
      ...
      curtain.animateCSS('fadeOut', function () {
        curtain.addClass('curtain--hidden');
      });
    }
  }

  var toggle = (0, _jquery.default)('.header__menu-toggle');
  var menu = (0, _jquery.default)('.menu');
  toggle.click(function () {
    if (menu.hasClass('menu--open')) {
      console.log('.menu--open, closing menu');
      menu.removeClass('menu--open');
      menu.animateCSS('fadeOut', function () {
